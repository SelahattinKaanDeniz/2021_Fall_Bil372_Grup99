...
drop table Pilot
drop table KabinMemuru
drop table Sefer
drop table Servis
drop table GenelBakim
drop table Tamir
drop table ServisPersoneli
drop table TamirPersoneli
drop table GenelBakimTeknisyeni*/
...
(
	...
	foreign key (PersonelID) references Personel(PersonelID),
	foreign key (ServisPersoneliID) references ServisPersoneli(ServisPersoneliID)
)
